        ...
        runOnUiThread(() -> {
                    ...
                    for (ClientMessage message : messages) {
                        ...
                        if (message.getSenderUsername().equals(this.presenter.getUsername())) {
                            content.addView(new ItemTextSend(this, text, message.getMessageId(), this, message.isImage()));
                        } else {
                            content.addView(new ItemTextReceive(this, text, message.getMessageId(), message.isImage()));
                        }
                    }
